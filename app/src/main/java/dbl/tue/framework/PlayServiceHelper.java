...
class PlayServiceHelper {
    ...
    public PlayServiceHelper(Activity activity) {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = LoginActivity.getInstance().getAppVersion();
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    regId = googleCloudMessaging.register("703447844334");
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = LoginActivity.getInstance().getAppVersion();
